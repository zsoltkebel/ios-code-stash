    ...
    private var mainView: some View {
        NavigationStack {
            ScannerView(
                ...
                onRecognizedItems: { recognizedItems in
                    print("recognised items")
                    if let recognisedItem = recognizedItems.first {
                        switch recognisedItem {
                        case .text(let text):
